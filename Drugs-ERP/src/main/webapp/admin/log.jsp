			 ...
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'}
			      ...
			      ,{field:'loginip', title:'登录ip地址',align:'center'}
		   ...
		   table.on('tool(logInfoTable)', function(obj){
			  ...
			  if(layEvent === 'del'){ //删除
				  layer.confirm('真的删除【'+data.loginname+'】这个日志吗', function(index){
				       //向服务端发送删除指令
				       $.post("../deleteLogInfo.do",{id:data.id},function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
							tableIns.reload();
				       })
			...
			function deleteBatch(){
			    ...
			    layer.confirm('真的删除选中的这些日志吗', function(index){
				       //向服务端发送删除指令
				       $.post("../deleteBatchLogInfo.do",params,function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
							tableIns.reload();
				       })
